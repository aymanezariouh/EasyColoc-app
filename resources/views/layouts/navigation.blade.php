        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center gap-8">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                    <span class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-600 text-sm font-semibold text-white">EC</span>
                    <span class="text-sm font-semibold tracking-wide text-slate-900">{{ config('app.name', 'EasyColoc') }}</span>
                </a>
            ...
            <div class="hidden sm:flex sm:items-center">
                <x-dropdown align="right" width="56">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-slate-700 hover:bg-slate-100">
                            ...
                            <span class="max-w-36 truncate font-medium">{{ Auth::user()->name }}</span>

    ...
    <div>
        ...
        <table border="1" cellpadding="4" cellspacing="0">
            ...
            <tbody>
                @forelse ($activeMemberships as $activeMembership)
                    <tr>
                        <td>{{ $activeMembership->user->name }}</td>
                        <td>{{ $activeMembership->user->email }}</td>
                        <td>{{ $activeMembership->role }}</td>
                        @if ($membership && $membership->role === 'owner')
                            <td>
                ...
                @empty
                    <tr>
                        <td colspan="{{ ($membership && $membership->role === 'owner') ? 4 : 3 }}">No active members.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <table border="1" cellpadding="4" cellspacing="0">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4">No balance data yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
